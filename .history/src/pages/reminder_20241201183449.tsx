...
export default function ReminderPage() {
  ...
  const [payments] = useState<Payment[]>([
    { id: 1, name: "Spotify", amount: "-£9.99", type: "Subscription", frequency: "Monthly" },
    { id: 2, name: "Netflix", amount: "-£15.99", type: "Subscription", frequency: "Monthly" },
    { id: 3, name: "Electricity Bill", amount: "-£50.00", type: "Bill", frequency: "Monthly" },
    { id: 4, name: "Water Bill", amount: "-£30.00", type: "Bill", frequency: "Quarterly" },
  ]);
  ...
  return (
    <Box bg="grayLight" minH="100vh" p={6}>
      <Flex justifyContent="space-between" alignItems="center" mb={4}>
        ...
        <Text fontSize="md" color="grayDark">
      ...
      <Box bg="white" p={6} borderRadius="lg" boxShadow="sm">
        ...
        {payments.map((payment) => (
          ...
          >
            <HStack>
              <Icon as={FiClock} boxSize={5} color="black" />
              <VStack align="start" spacing={0}>
                <Text fontWeight="bold" color="black">
                  {payment.name}
                </Text>
                <Text fontSize="sm" color="grayDark">
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button bg="greenDark" color="white" mr={3} onClick={handleSetReminder}>
              Set Reminder
            </Button>
      ...
      <Box bg="white" mt={6} p={6} borderRadius="lg" boxShadow="sm">
        ...
        {remindersList.length > 0 ? (
          ...
          <Text color="grayDark">No reminders added yet.</Text>
        )}
      </Box>
    </Box>
  );
